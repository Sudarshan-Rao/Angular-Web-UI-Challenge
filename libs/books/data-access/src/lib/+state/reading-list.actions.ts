...
export const addToReadingListUndo = createAction(
  '[Reading List API] Add to list undo',
  props<{ book: Book }>()
);

export const removeFromReadingListUndo = createAction(
  '[Book Search Results] Remove from list undo',
  props<{ item: ReadingListItem }>()
);
